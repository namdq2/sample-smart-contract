...
const addressSM = '0x9F165540c90094900c71AB760803895A801E401E';
const baseNetworkScanUrl = 'https://rinkeby.etherscan.io/tx/';
...
export default function Home() {
    ...
    const deposit = async () => {
        ...
        if (address[0] === accounts[0]) {
            ...
            const contractMM = new web3.eth.Contract(ABI, addressSM);

            contractMM.methods.deposit().send({
                from: address[0],
            ...
            setError("Please reload your wallet address.");
        }
    }
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <div className={styles.container}>
                    {address.length > 0 ? (
                        <>
                            <h2 className={styles.center}>Hi {address}
                                <button className={styles.reloadAccount} onClick={login}>reload</button>
                            </h2>
                            <button
